            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <input wire:model="new_pago_ins" type="file" class="form-control" id="new_pago_ins"
                            accept=".png, .jpg, .jpeg">
                        ...
                        <div>
                            @if($new_pago_ins)
                            <img src="{{ $new_pago_ins->temporaryUrl() }}" alt="Preview"
                                style="max-width: 100%; height: auto;">
                            @elseif($pago_ins)
                            <img src="{{ asset('storage/pagos/' . $pago_ins) }}" alt="Pago Ins"
                    ...
                    <div class="form-group">
                        ...
                        <input wire:model="pago_ins" type="text" class="form-control" id="pago_ins"
