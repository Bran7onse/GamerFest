    ...
    font-size:15px; ">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="table-primary border border-dark">{{ $row->jugadors1->nombre_ind }}</td>
                            <td class="table-info border border-dark">{{ $row->jugadors2->nombre_ind }}</td>
                            <td class="table-primary border border-dark">{{ $row->jugadors3->nombre_ind }}</td>
